...
public:
	...
	{
		world.x = geoTransform[0] + linesample.x*geoTransform[1] + linesample.y*geoTransform[2];
		world.y = geoTransform[3] + linesample.x*geoTransform[4] + linesample.y*geoTransform[5];
	};
